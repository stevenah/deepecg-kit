...
Usage:
    python examples/evaluate_model.py --checkpoint runs/kanres-af/checkpoints/best.ckpt --model kanres --dataset af-classification
    python examples/evaluate_model.py --checkpoint model.ckpt --model afmodel --dataset af-classification --output-dir results/
"""
...
def main():
    ...
    lit_model = ECGLitModel.load_from_checkpoint(args.checkpoint, model=model)
    lit_model.eval()
