...
Examples:
  ...
  deepecg evaluate --checkpoint model.ckpt -m kanres -d af-classification
  deepecg predict --checkpoint model.ckpt -m kanres --input ecg.npy
  deepecg resume --checkpoint model.ckpt -m kanres --epochs 100
  deepecg list-models
